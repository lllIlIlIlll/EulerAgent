...
1. 打开 [GitHub 仓库页面](https://github.com/lsdefine/EulerAgent)
...
> 💡 这就是 EulerAgent 的核心设计理念：**代码即文档**。Agent 能读懂自己的源码，所以任何功能你都可以直接问它。

---

## 💡 使用越久越强

EulerAgent 不预设技能，而是**靠使用进化**。每完成一个新任务，它会自动将执行路径固化为 Skill，下次遇到类似任务直接调用。
