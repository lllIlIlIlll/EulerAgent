...
conductor_agent: Optional[EulerAgent] = None
...
def start_agent_runner(agent: EulerAgent, name: str):
...
def monitor_display_queue(agent_id: str, dq: "queue.Queue", trigger_when_done: bool):
    """Consume one EulerAgent display_queue.
