"""
ea_cli/cli.py - EulerAgent 命令行分发系统

通过 python -m ea_cli <命令> 或 ea <命令> 调用
"""
...
COMMANDS = {
    ...
    "cli": {
        ...
        "cmd": ["python", "{PROJECT_DIR}/core/agentmain.py"],
    },
    "launch": {
    ...
    "status": {
        "help": "检查运行状态",
        "desc": "检查当前是否已有 EulerAgent 进程在运行",
        "cmd": None,
        "internal": True,
    },
    "update": {
