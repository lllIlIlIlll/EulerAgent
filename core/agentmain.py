...
if not os.path.exists(mem_insight):
    t = os.path.join(script_dir, f'../assets/template/global_mem_insight_template{lang_suffix}.txt')
...
class EulerAgent:
    ...
    def run(self):
        while True:
            ...
            handler = EulerAgentHandler(self, self.history, os.path.join(script_dir, '../temp'))
